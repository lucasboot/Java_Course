    ...
    private void initComponents() {
        ...
        jPanelToolBarLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelToolBarLayout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(jLabelToolBarTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        try{
             if(!jTextFieldName.getText().equals("")){
                ...
                JOptionPane.showMessageDialog(rootPane, "Projeto não foi salvo, o campo nome não foi preenchido");
             }
        } catch(Exception e){
